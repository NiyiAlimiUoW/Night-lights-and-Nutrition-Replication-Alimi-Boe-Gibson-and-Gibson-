...
Please download the Nigerian DHS Data from the DHS program
*/
...
global Root "G:\My Drive\Nutrition and light replicated"
...
summ DMSP_point l_DMSP_point HAZ stunted WHZ wasted WAZ underweight boy_child age_of_child birth_order mother_edu age_mother_first father_edu  wlth_q_* has_tv reads_newspaper visit_family_planning 
...
local sample l_DMSP_point,boy_child, age_of_child, birth_order, mother_edu, age_mother_first, father_edu,  v190, has_tv, reads_newspaper, visit_family_planning
...
summ HAZ stunted l_DMSP_point l_DMSP_point_c boy_child age_of_child birth_order mother_edu age_mother_first father_edu  ib1.v190 has_tv reads_newspaper visit_family_planning 
...
foreach light in l_DMSP_point_c  {
 ...
 local controls boy_child age_of_child birth_order mother_edu age_mother_first father_edu wlth_q_2 wlth_q_3 wlth_q_4 wlth_q_5 has_tv reads_newspaper visit_family_planning yr_2
...
outreg2 using "${Output}\AppdxA_`light'.out", keep(`light' 2013.year) `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval',  BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value),`margins_p')
outreg2 using "${Output}\AppdxA_`light'_full.out", `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval', Condition Number, `CN_`light'', BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
...
outreg2 using "${Output}\AppdxA_`light'.out", keep(`light' c.`light'#c.`light' 2013.year) `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval',  BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
outreg2 using "${Output}\AppdxA_`light'_full.out", `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval',  BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
...
outreg2 using "${Output}\AppdxA_`light'.out", keep(`light' c.`light'#c.`light' c.`light'#c.`light'#c.`light' 2013.year) `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval', BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
outreg2 using "${Output}\AppdxA_`light'_full.out", `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval', BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
...
outreg2 using "${Output}\AppdxA_`light'.out", keep(`light' c.`light'#c.`light' c.`light'#c.`light'#c.`light' c.`light'#c.`light'#c.`light'#c.`light' 2013.year) `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval', BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
...
outreg2 using "${Output}\AppdxA_`light'.out", keep(`light' c.`light'#c.`light' c.`light'#c.`light'#c.`light' c.`light'#c.`light'#c.`light'#c.`light' c.`light'#c.`light'#c.`light'#c.`light'#c.`light' 2013.year ) `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval', BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
...
outreg2 using "${Output}\AppdxA_`light'.out", keep(`light' c.`light'#c.`light' c.`light'#c.`light'#c.`light' c.`light'#c.`light'#c.`light'#c.`light' c.`light'#c.`light'#c.`light'#c.`light'#c.`light'  c.`light'#c.`light'#c.`light'#c.`light'#c.`light'#c.`light' 2013.year) `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval', BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
