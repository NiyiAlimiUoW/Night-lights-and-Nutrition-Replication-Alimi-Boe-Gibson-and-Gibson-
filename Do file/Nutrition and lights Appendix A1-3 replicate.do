...
outreg2 using "${Output}\AppdxA_`light'",excel keep(`light' 2013.year) `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval',  BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value),`margins_p')
outreg2 using "${Output}\AppdxA_`light'_full", excel `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval', Condition Number, `CN_`light'', BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
...
outreg2 using "${Output}\AppdxA_`light'", excel keep(`light' c.`light'#c.`light' 2013.year) `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval',  BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
outreg2 using "${Output}\AppdxA_`light'_full", excel `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval',  BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
...
outreg2 using "${Output}\AppdxA_`light'", excel keep(`light' c.`light'#c.`light' c.`light'#c.`light'#c.`light' 2013.year) `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval', BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
outreg2 using "${Output}\AppdxA_`light'_full", excel `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval', BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
...
outreg2 using "${Output}\AppdxA_`light'", excel keep(`light' c.`light'#c.`light' c.`light'#c.`light'#c.`light' c.`light'#c.`light'#c.`light'#c.`light' 2013.year) `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval', BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
...
outreg2 using "${Output}\AppdxA_`light'", excel keep(`light' c.`light'#c.`light' c.`light'#c.`light'#c.`light' c.`light'#c.`light'#c.`light'#c.`light' c.`light'#c.`light'#c.`light'#c.`light'#c.`light' 2013.year ) `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval', BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
...
outreg2 using "${Output}\AppdxA_`light'", excel keep(`light' c.`light'#c.`light' c.`light'#c.`light'#c.`light' c.`light'#c.`light'#c.`light'#c.`light' c.`light'#c.`light'#c.`light'#c.`light'#c.`light'  c.`light'#c.`light'#c.`light'#c.`light'#c.`light'#c.`light' 2013.year) `apprep' ${regopts} dec(4) ctitle(`var'_`light') addtext(Child and parental characteristics, Yes) addstat(F-test, `F', F-testP-value, `pval', BIC, `BIC', Margins(dy/dx), `margins', Margins(se), `margins_se', Margins(p-value), `margins_p')
